...
" );
            ...
            RockMigrationHelper.UpdateBlockType( "Referral Agency Detail", "Displays the details of a Referral Agency.", "~/Plugins/org_sdk/SampleProject/ReferralAgencyDetail.ascx", "org_sdk > Sample Project", "2F130DF6-1EE4-45CE-9410-CBB0517EB33E" );
            RockMigrationHelper.UpdateBlockType( "Referral Agency List", "Lists all the Referral Agencies.", "~/Plugins/org_sdk/SampleProject/ReferralAgencyList.ascx", "org_sdk > Sample Project", "53F447CE-4B91-470A-A15D-B60DCAAB29CB" );
        ...
        {
            Sql( @"
    UPDATE [_org_sdk_SampleProject_ReferralAgency] SET [AgencyTypeValueId] = NULL
" );
