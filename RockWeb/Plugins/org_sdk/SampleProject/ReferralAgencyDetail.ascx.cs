...
namespace RockWeb.Plugins.org_sdk.SampleProject
{
    /// <summary>
    /// Displays the details of a Referral Agency.
    /// </summary>
    [DisplayName( "Referral Agency Detail" )]
    [Category( "org_sdk > Sample Project" )]
    ...
    public partial class ReferralAgencyDetail : Rock.Web.UI.RockBlock
    {
        ...
        protected override void OnInit( EventArgs e )
        {
            ...
            var definedType = DefinedTypeCache.Read( org.sdk.SampleProject.SystemGuid.DefinedType.REFERRAL_AGENCY_TYPE.AsGuid() );
            if (definedType != null)
            {
